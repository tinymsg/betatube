...
<html>
        ...
        <div class="www-core-container www-watch-page">
            ...
            <div class="www-home-left">
                ...
                <div class="watch-main-area-bottom">
                    <div id="share-panel">
                        <a href="#">MySpace</a> 
                        <a href="https://twitter.com/intent/tweet?url=https://betatube.net/watch?v=<?php echo $_video['rid']; ?>&text=<?php echo htmlspecialchars($_video['title']); ?>&related=Betatube,Fulptube">Twitter</a> 
                        <a href="https://bwitter.me/share?text=<?php echo htmlspecialchars($_video['title']); ?> | https://betatube.net/watch?v=<?php echo $_video['rid']; ?>">Bwitter</a> 
                        <a href="https://facebook.com/sharer/sharer?u=https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fbetatube.net/watch?v=<?php echo $_video['rid']; ?>">Facebook</a>
                    </div>
                    ...
                    <?php if(!isset($_SESSION['siteusername'])) { ?>
                        <div class="benifits-outer-front" style="height: unset;">
                            <div class="benifits-inner-front" style="float: unset;width: unset;margin-top:unset;">
                                ...
                                <a href="/sign_up">Sign up for a Betatube Account</a>
                            </div>
                        </div>
                        <?php } else { ?>
                            <div class="benifits-outer-front" style="height: unset;">
	...
	<?php	}	?>
                            ...
                            <span id="reply_to_<?php echo $comment['id']; ?>" style="display: none;">
                                ...
                                <div class="comment-watch">
                                    <span class="comment-info">
                                        <b><a style="text-decoration: none;" href="/user/<?php echo htmlspecialchars($comment['author']); ?>">
                                            Reply to <?php		if($_user2['partner'] == "y") { ?>
	<?php if($_user2['title'])	{	?>
	<?php echo htmlspecialchars($_user2['title']); ?>
	<?php } else {	?>
	<?php echo htmlspecialchars($_user2['username']); ?>
	...
	<?php	}	?>
                                        ...
                                        <span class="comment-text">
                                            <form method="post" action="/d/reply?id=<?php echo $comment['id']; ?>&v=<?php echo $_GET['v']; ?>" enctype="multipart/form-data">
            ...
            <div class="www-home-right">
                ...
                <div class="channel-info-video">
                    ...
                    <div class="share-video">
                        URL <input value="https://betatube.net/watch?v=<?php echo $_video['rid']; ?>"><br>
                        Embed <input style="margin-right: 13px;" value='<iframe style="border: 0px; overflow: hidden;" src="https://betatube.net/2009player/lolplayer?id=<?php echo $_video['rid']; ?>" height="365" width="646"></iframe>'>
                    </div>
                </div>
                <?php if(@$_SESSION['siteusername'] == $_video['author']) { ?>
