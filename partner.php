...
<?php
	$__server->page_embeds->page_title = "Betatube Partners";
	$__server->page_embeds->page_description = "partner with betatube 2 be cool";
	...
	<body dir="ltr" class="  ltr      site-left-aligned  exp-new-site-width  exp-watch7-comment-ui  hitchhiker-enabled      guide-enabled    guide-expanded  ">
		<div id="body-container">
            ...
            <div class="manage-base" style="position: relative;left: 9px;top: 3px;">
                ...
                Wanna get cool perks for your channel? Come sign up to be a partner.<br><br>
                <button type="button" class="collapsible"><img class="www-right-arrow" id="arrow_more">Perks</button>
                <div class="content" style="">
                    By being a partner... You get<br>
                    - A cool badge on your channel<br>
                    - Channel titles<br>
                    - Quick support with any problems<br>
                    - You will earn +100 social credits<br>
                </div><br><br>

                <button type="button" class="collapsible"><img class="www-right-arrow" id="arrow_more">Requirements</button>
                <div class="content" style="">
					...
					- You must have at least 5 subscribers
                </div><br><br>
                <div class="content">
					You can apply by dming Hwilliams8548 on discord (discord in footer)
                </div>
            </div>
					</div>
				</div>
