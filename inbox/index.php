...
<?php
	$__server->page_embeds->page_description = "Betatube";
                                    ...
                                    <tr style="margin-top: 5px;" id="videoslist">
                                        ...
                                        <td class="video-manager-stats" style="background: none;padding-left: 8px;font-size: 10px;">
                                            ...
                                            <span style="display: inline-block; vertical-align:top;width: 87px;">
												<?php $_user22 = $__user_h->fetch_user_username($inbox['owner']); ?>
												<?php
													if($_user22['title'])	{
												...
												?>
                                                <b><a href="/user/<?php echo htmlspecialchars($inbox['owner']); ?>"><?php echo htmlspecialchars($cdname); ?></a></b><br>
												...
												<?php if($_user22['title'])	{ ?><?php echo htmlspecialchars($inbox['owner']); ?><?php } ?>
                                            </span><br><br>
