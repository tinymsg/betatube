...
<?php
	$__server->page_embeds->page_title = "Betatube - Notifications";
	$__server->page_embeds->page_description = "beta tube is good";
					...
					<div class="browse-container ytg-wide ytg-box no-stage browse-bg-gradient">
						<div class="ytg-fl browse-content">
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
								...
								<h1 style="display:inline-block;">Your Notifications</h1>
                                ...
                                <?php
                                    ...
                                    $stmt = $__db->prepare("SELECT * FROM pms WHERE touser = :username AND type = 'nt' AND readed = 'y' ORDER BY id DESC");
