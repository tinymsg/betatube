...
<?php
	$__server->page_embeds->page_title = "Betatube - Sent Messages";
	$__server->page_embeds->page_description = "Betatube is a site dedicated to bring back the 2012 layout of YouTube.";
					...
					<div class="browse-container ytg-wide ytg-box no-stage browse-bg-gradient">
						<div class="ytg-fl browse-content">
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
								...
								<h1 style="display:inline-block;">Your Sent PMs</h1>
                                ...
                                <?php
                                    ...
                                    $stmt = $__db->prepare("SELECT * FROM pms WHERE owner = :username AND readed = 'y' ORDER BY id DESC");
