...
<?php
	$__server->page_embeds->page_title = "Betatube - Terms & Conditions";
						...
						<div class="ytg-fl browse-content">
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
								<div class="browse-collection  has-box-ad">
                                    ...
                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">All the materials on SubRocks’s Website are provided "as is". SubRocks makes no warranties, may it be expressed or implied, therefore negates all other warranties. Furthermore, SubRocks does not make any representations concerning the accuracy or reliability of the use of the materials on its Website or otherwise relating to such materials or any sites linked to this Website.</p>

                                    <h2>3. Limitations</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">SubRocks or its suppliers will not be hold accountable for any damages that will arise with the use or inability to use the materials on SubRocks’s Website, even if SubRocks or an authorize representative of this Website has been notified, orally or written, of the possibility of such damage. Some jurisdiction does not allow limitations on implied warranties or limitations of liability for incidental damages, these limitations may not apply to you.</p>

                                    <h2>4. Quality Control</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">SubRocks or its suppliers will remove your video/content if it is considered low effort by the staff team without any warning.</p>

                                    <h2>5. Revisions and Errata</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">The materials appearing on SubRocks’s Website may include technical, typographical, or photographic errors. SubRocks will not promise that any of the materials in this Website are accurate, complete, or current. SubRocks may change the materials contained on its Website at any time without notice. SubRocks does not make any commitment to update the materials.</p>

                                    <h2>6. Links</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">SubRocks has not reviewed all of the sites linked to its Website and is not responsible for the contents of any such linked site. The presence of any link does not imply endorsement by SubRocks of the site. The use of any linked website is at the user’s own risk.</p>

                                    <h2>7. Site Terms of Use Modifications</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">SubRocks may revise these Terms of Use for its Website at any time without prior notice. By using this Website, you are agreeing to be bound by the current version of these Terms and Conditions of Use.</p>
