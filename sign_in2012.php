...
<?php
	$__server->page_embeds->page_title = "Betatube - Sign In";
	$__server->page_embeds->page_description = "log in";
			...
			<div id="content-container">
				...
				<div id="content" style="">
					...
					<div class="www-left">
						...
						</ul><br><a href="/sign_up">Sign up now </a> to make a BetaTube channel.<br>
<br><br>
					</div>
					<div class="www-right">
