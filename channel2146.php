...
<html>
    <head>
        <title>Betatube - <?php echo $_base_utils->return_current_page(); ?>'s channel</title>
                ...
                <div style="background: <?php echo htmlspecialchars($_user['secondary_color']); ?>;color: <?php echo htmlspecialchars($_user['primary_color_text']); ?>;padding: 2px;border-radius: 5px;">
                    <div class="www-channel-top">
                        ...
                        <?php if(@$_SESSION['siteusername'] != $_user['username']) { ?>
                            ...
                            <?php } else { ?>
                            <a href="#">
                                <button style="margin: 0px;float: none;margin-left: 15px;" class="sub_button" onclick="window.location.href='/account'">Edit Channel</button>
                            </a>
                        <?php } ?>
                    </div>
                ...
                <div class="www-channel-two-left">
                    ...
                    <?php if($_user['featured'] != "None" && $_video_fetch_utils->video_exists($_user['featured'])) { 
                        ...
                        <div id="playlist-panel" class="featured-video-info" style="display: none;min-height: 124px;color: <?php echo htmlspecialchars($_user['text_color']); ?>;width: 100%;border-radius: 3px;background: <?php echo htmlspecialchars($_user['primary_color']); ?>;">
                            <a href="#">MySpace</a> 
                            <a href="https://twitter.com/intent/tweet?url=https://subrock.rocks/watch?v=<?php echo $video['rid']; ?>&text=<?php echo htmlspecialchars($video['title']); ?>&related=Betatube,Fulptube">Twitter</a> 
                    ...
                    <?php } else { ?>
                        ...
                        <div id="playlist-panel" class="featured-video-info" style="display: none;min-height: 124px;color: <?php echo htmlspecialchars($_user['text_color']); ?>;width: 100%;border-radius: 3px;background: <?php echo htmlspecialchars($_user['primary_color']); ?>;">
                            <a href="#">MySpace</a> 
                            <a href="https://twitter.com/intent/tweet?url=https://betatube.net/watch?v=<?php echo $video['rid']; ?>&text=<?php echo htmlspecialchars($video['title']); ?>&related=Betatube,Fulptube">Twitter</a> 
                            <a href="https://bwitter.me/share?text=<?php echo htmlspecialchars($video['title']); ?> | https://betatube.net/watch?v=<?php echo $video['rid']; ?>">Bwitter</a> 
                            <a href="https://facebook.com/sharer/sharer?u=https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fbetatube.net/watch?v=<?php echo $video['rid']; ?>">Facebook</a>
                        </div>
            ...
            <?php } else { ?>
                <?php if(isset($_SESSION['siteusername']) && $_SESSION['siteusername'] == $_user['username'] && $_user['videos'] == 0) { ?>
                    <div style="color: <?php echo htmlspecialchars($_user['primary_color_text']); ?>;padding: 5px;border: 2px solid <?php echo htmlspecialchars($_user['secondary_color']); ?>;position: relative;bottom: 3px;">
                        <h1>Welcome to your Betatube channel!</h1>
                        You can:<br>
