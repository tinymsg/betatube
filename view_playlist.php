...
<?php
    ...
    if(!$__user_h->user_exists($_playlist['author']))
        header("Location: /?error=This playlist cannot be displayed because the owner's account no longer exists!");    
...
?>
<?php
	$__server->page_embeds->page_title = "Betatube - " . htmlspecialchars($_playlist['title']);
											...
											<div class="upper-left-section " style="padding: 0px;">
												...
												<h1 title="<?php echo htmlspecialchars($_playlist['title']); ?>"><?php echo htmlspecialchars($_playlist['title']); ?></h1>
													<p class="channel-author-attribution">
														by <a href="/user/<?php echo htmlspecialchars($_playlist['author']); ?>">
												<?php if($_user['title'])	{	?>
															...
															<?php
																...
																foreach($_playlist['videos'] as $video) {
																	...
																	<li class="playlist-video-item
																		...
																		by <span class="yt-user-name " dir="ltr"><?php echo htmlspecialchars($_user2['title']); ?></span>
																		</span>
																		<span class="video-view-count">
																		<?php echo $_video['views']; ?> views
																		<?php } else {	?>
																		<span class="video-owner">
																		by <span class="yt-user-name " dir="ltr"><?php echo htmlspecialchars($_user2['username']); ?></span>
																		</span>
																		<span class="video-view-count">
																		<?php echo $_video['views']; ?> views
																		<?php	}	?></a>
