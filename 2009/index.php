                ...
                <div class="grid-view">
                    ...
                    ?> 
                        <div class="grid-item recent-view">
                            <a href="/watch?v=<?php echo $video['rid']; ?>">
                            <img class="thumbnail recent-video-thumbnail" onerror="this.onerror=null;this.src='/dynamic/thumbs/default.jpg';" src="/dynamic/thumbs/<?php echo htmlspecialchars($video['thumbnail']); ?>">
                            </a>
