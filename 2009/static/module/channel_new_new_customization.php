    ...
    <table id="layout-table" style="display: none;width: 960px;padding: 10px;"> 
        ...
        <tr>
            <td style="vertical-align: top;">
                ...
                <span style="font-size: 11px;" class="grey-text">This will set the list of featured channels in the custom module named "channels"<br>SEPERATE BY COMMAS, ex: Luke,hwilliams8548,Betatube</span><br>
                <form method="post" id="featuredvid" action="/post/channel_update_new" enctype="multipart/form-data">
