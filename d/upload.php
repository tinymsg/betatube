...
<?php
    ...
    if( $video_validation->video_file_type == ".css" || 
        $video_validation->video_file_type == ".sql" || 
        $video_validation->video_file_type == ".php" || 
        $video_validation->video_file_type == ".htm" || 
        $video_validation->video_file_type == ".html"
    ) {
        $video_validation->upload_error = "fuck off" . $_FILES['video_file']['error'];
        $video_validation->upload_ok = 0;
    }
