...
<?php
	$__server->page_embeds->page_title = "Betatube - Search";
                                 ...
                                 <div id="" class="yt-uix-tile yt-lockup-list yt-tile-default yt-grid-box ">
                                    ...
                                    <div class="yt-lockup-content">
                                       ...
                                       <div style="font-size: 11px;" class="yt-lockup-meta">
                                          <p class="facets">
                                             <span  style="font-size: 11px;" class="username-prepend">by     <a href="/user/<?php echo $video['author']; ?>" class="yt-user-name " dir="ltr"><?php echo $video['dname']; ?></a>
                                             </span>
