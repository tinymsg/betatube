...
Loading...
  ...
  <div id="yt-dialog-working-bubble">
    ...
    <a class="spf-link yt-uix-button-menu-item" href="/user/<?php echo htmlspecialchars($_user['username']); ?>">Browse</a>
  </li>

        <li>
    <a class="spf-link yt-uix-button-menu-item" href="/user/<?php echo htmlspecialchars($_user['username']); ?>">Feed</a>
  </li>
      ...
      <li>
        <a href="/user/<?php echo htmlspecialchars($_user['username']); ?>&channels" class="yt-uix-button selected spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item" data-sessionlink="ei=bdi8UZPkOOKVhgHu94HAAQ"><span class="yt-uix-button-content">Channels</span></a>
      </li>
        <li>
...
<div class="video-content-info">
    ...
    <h2 class="branded-page-module-title">
        <a class="yt-uix-sessionlink " href="/user/<?php echo htmlspecialchars($_user['username']); ?>&channels" title="Recent uploads" data-sessionlink="ei=bdi8UZPkOOKVhgHu94HAAQ&amp;ved=CEMQzh4">
          Featured Channels
        </a>

        <a href="/user/<?php echo htmlspecialchars($_user['username']); ?>&channels" class="yt-uix-button  shelves-play yt-uix-sessionlink yt-uix-button-default yt-uix-button-short" data-sessionlink="ei=bdi8UZPkOOKVhgHu94HAAQ"><img class="yt-uix-button-icon yt-uix-button-icon-play-all" src="//web.archive.org/web/20130615211109im_/http://s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif" alt="" title=""><span class="yt-uix-button-content">Play</span></a>
    </h2>
    ...
    <div class="module-view other-channels-view">
        ...
        <?php if(@$_SESSION['siteusername'] == $_user['username']) { 
            echo "<a href='#' style='float:right;font-size:11px;color:black;' onclick=';open_featured_channels();return false;'></a>"; 
        } ?>
