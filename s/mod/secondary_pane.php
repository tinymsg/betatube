...
<div class="user-profile channel-module yt-uix-c3-module-container ">
    <div class="module-view profile-view-module" data-owner-external-id="IwFjwMjI0y7PDBVEO9-bkQ">
        <h2>About <?php if($_user['title'])	{	?><?php echo htmlspecialchars($_user['title']); ?><?php } else {	?><?php echo htmlspecialchars($_user['username']); ?><?php	}	?></h2>
        ...
        <div class="section created-by-section">
            <div class="user-profile-item">
                by <span class="yt-user-name " dir="ltr"><?php if($_user['vanity'])	{	?><?php echo htmlspecialchars($_user['vanity']); ?><?php } else{ ?><?php echo htmlspecialchars($_user['username']); ?><?php } ?></span>
            </div>
            <div class="user-profile-item ">
        ...
        <div class="module-view gh-featured">
            ...
            ?> 
                <div class="playlist yt-tile-visible yt-uix-tile">
                    ...
                    by <?php if($_user['title'])	{	?><?php echo htmlspecialchars($_user['title']); ?><?php } else {	?><?php echo htmlspecialchars($_user['username']); ?><?php	}	?>
                    </span>
                </div>
            <?php }  ?>
        </div>
