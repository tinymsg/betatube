...
<div id="footer">
    ...
    <div id="footer-logo">
        <a href="/" title="Betatube home">
        <img src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="Betatube">
        </a>
        <span id="footer-divider"></span>
    </div>
    <div id="footer-main">
        <ul id="footer-links-secondary">
            <li><a href="https://discord.gg/uPy2QyuMg8">Discord</a></li>
            <li><a href="https://betatube.net/layouts/">Layouts</a></li>
