...
<div id="guide-container" class="<?php if(parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH) == "/watch") { ?>collapsible-guide<?php } ?>">
    <div id="guide-main" class="guide-module <?php if(parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH) == "/watch") { ?>collapsed<?php } ?>">
