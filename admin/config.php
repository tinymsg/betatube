				...
				<div id="page" class="  home     branded-page-v2-detached-top  clearfix">
					...
					<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
						<div class="browse-collection  has-box-ad">
								<b>Admin Configs</b>
								<p>turn things on and off.</p>
								<hr>
								<form method="POST" action="/d/admin?action=signups">
									<br>
									<h3>Signups</h3><br>
									<span style="font-size:11px;color:grey;">
										<b>if mquin spams us, turn this off</b><br>
									</span><br>
									<select name="signups">
										<option value="1">On</option>
										<option value="0">Off</option>
									</select>
									<input type="submit" value="Apply" class="yt-uix-button yt-uix-button-default">
								</form>
						</div>
					</div>
				</div>
