					...
					<div id="browse-main-column" style="float: left;margin: 14px 0 0 25px;" class="ytg-4col">
						<div class="browse-collection  has-box-ad">
								...
								<hr><br>
                                                                ...
                                                                $stmt = $__db->prepare("SELECT * FROM users ORDER BY id DESC");
                                                                $stmt->execute();
                                                                ...
                                                                $stmt = $__db->prepare("SELECT * FROM users ORDER BY id DESC LIMIT :pfirst, :pper");
						...
						<a href="/user/<?php echo htmlspecialchars($user['username']) ?>"><img src="/dynamic/pfp/<?php echo htmlspecialchars($user['pfp']); ?>" style="float:left;height:85px;width:74px;margin-right:15px"></a>
						...
						<a href="/admin/users?page=<?php echo $page + 1 ?>">Next page</a>
					</div>
				</div>
			</div>
		</div>
