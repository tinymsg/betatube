					...
					<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
						<div class="browse-collection  has-box-ad">
							<h2 class="branded-page-module-title">
								<a class="spf-link yt-uix-sessionlink" title="adminz" data-sessionlink="ved=CAoQzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
									Admin Panel
								</a>
							</h2>
								<hr>
								<a href="/admin/stats"><h2>Stats</h2></a>
								<a href="/admin/users"><h2>Users</h2></a>
								<a href="/admin/config"><h2>Config</h2></a>
						</div>
					</div>
				</div>
			</div>
