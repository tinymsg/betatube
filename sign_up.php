...
<?php
	$__server->page_embeds->page_title = "Betatube - Sign Up";
	$__server->page_embeds->page_description = "Betatube is a website using the old YouTube layout";
	...
	<body id="" class="date-20120930 en_US ltr   ytg-old-clearfix guide-feed-v2 " dir="ltr">
		...
		<div id="page" class="">
			...
			<div id="content-container">
				<!-- begin content -->
				<div id="content">
                    <h2>Sign up to Betatube</h2>
                    <br>
					<div class="www-left">
						<b>Join the least gay video-sharing community!</b><br>
						Sign up now to get full access with your Betatube account: <br><br>
						<ul>
					...
					<div class="www-right">
						<div class="sign-in-div">
							<form method="POST" action="/d/signup_mquinproof">
...
<br><span class="small-text">Your email must be a valid email</span><br><br>
