...
<?php header("Location: /new_upload") ?>
<?php
	$__server->page_embeds->page_title = "Betatube";
	$__server->page_embeds->page_description = "beeeetaaaa toooooob";
				...
				<div id="content">
                    ...
                    <div class="upload-div-base">
                        ...
                        <div class="www-upload-left">
                            ...
                            <form enctype="multipart/form-data" id="upload_form" action="/d/upload_video.php" method="post">
