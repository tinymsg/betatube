						...
						<div class="branded-page-v2-container enable-fancy-subscribe-button  branded-page-v2-secondary-column-hidden">
							<div class="branded-page-v2-col-container clearfix">
											<td colspan="2" style="padding: 30px 30px 30px 30px;">
												<div style="font: 13px/1.5 Arial;">
												<h2 style="font-size: 20px; margin: 1em 0 0 0;">
													Welcome to the Betatube community!
												</h2>
												<p style="margin: 0; padding: 0;">
												By signing in to your Betatube+ account, you are now signed into Betatube!<br>
												You'll be able to interact with everyone on Betatube and get personalized<br>
												recommendations for cool videos to watch.
												</p>
												<h3 style="border-bottom: 1px solid #DDD; font-size: 16px; font-weight: normal; margin: 1em 0 .2em 0;">
													Watch what you like most
												</h3>
												<ul style="margin: 0; padding: 0;">
												<li style="margin: 0; padding: 0; list-style: none;">
												<a href="https://betatube.net/">Subscribe to your favorite channels</a>
												</li>
												<li style="margin: 0; padding: 0; list-style: none;">
												...
												<div style="border-top: 1px solid #DDD; line-height: 2em; margin-top: 1em; padding-top: 1em;">
												<table width="100%" style="font: 13px/1.5 Arial;">
												<tr>
												<td>
													Happy Betatube-ing!
												</td>
