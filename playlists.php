...
?>
<?php
	$__server->page_embeds->page_title = "Betatube - Your Playlists";
	$__server->page_embeds->page_description = "Betatube is a website using the 2012 YouTube layout";
						...
						<div class="ytg-fl browse-content">
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
                                ...
                                <?php
                                    ...
                                    $stmt->execute();
                                ?>
								<h1 style="display:inline-block;">Your Playlists (<?php echo $stmt->rowCount(); ?>)</h1><br>
								<hr><br>
                                <?php
                                ...
                                <div id="ex1" class="modal">
                                    <form method="post" enctype="multipart/form-data" id="submitform" style="top:0px;">
                                        <div >
                                            ...
                                            <span style="font-size: 11px;" class="grey-text">Playlists are still in a buggy state. Report bugs to the discord server (in the footer).</span><br><br>
                                            <input class="yt-uix-form-input-text" placeholder="Playlist Title" type="text" name="title" style="width: 85% !important;" required="required"><br>
                                        </div><br>
                                        <div >
                                            <textarea class="yt-uix-form-input-text" style="width: 85%;width: 85% !important;" id="com" placeholder="Description" name="comment"></textarea><br><br>
