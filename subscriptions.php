...
<?php
	$__server->page_embeds->page_title = "Betatube - Subscriptions";
                                    ...
                                    <?php while($user = $stmt->fetch(PDO::FETCH_ASSOC)) {  ?> 
                                        <div style="width: 33%;display: inline-block;">
                                            ...
                                            <span style="display: inline-block; vertical-align:top;width: 100px;font-size: 11px;">
												<?php $_user22 = $__user_h->fetch_user_username($user['reciever']); ?>
												<?php
													if($_user22['title'])	{
														$cdname = $_user22['title'];
													} else{
														$cdname = $user['reciever'];
													}
												?>
                                                <b><a href="/user/<?php echo htmlspecialchars($user['reciever']); ?>"><?php echo htmlspecialchars($cdname); ?></a></b><br>
