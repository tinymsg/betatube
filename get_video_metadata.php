...
$_video = $__video_h->fetch_video_rid($_GET['video_id']);
	...
	'subscription_button_html' => '<span class=" yt-uix-button-subscription-container" ><button onclick=";subscribe();return false;"  type="button" class="yt-uix-subscription-button yt-uix-button yt-uix-button-subscribe-branded yt-uix-button-size-default" aria-live="polite" aria-busy="false" onclick=";return false;" aria-role="button" data-channel-external-id="UCBR8-60-B28hp2BmDPdntcQ" data-style-type="branded" data-sessionlink="feature=html5-player&amp;ei=mXUPUtbaDOOQhgGv14H4Ag" role="button">    <span class="yt-uix-button-icon-wrapper">      <img class="yt-uix-button-icon yt-uix-button-icon-subscribe" src="//s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif" alt="" title="">      <span class="yt-uix-button-valign"></span>    </span>    <span class="yt-uix-button-content"><span class="subscribe-label" aria-label="Subscribe">Subscribe</span><span class="subscribed-label" aria-label="Unsubscribe">Subscribed</span><span class="unsubscribe-label" aria-label="Unsubscribe">Unsubscribe</span>     </span></button><span class="yt-subscription-button-subscriber-count-branded-horizontal" >' . $__user_h->fetch_subs_count($_video['author']) .'</span>  <span class="yt-subscription-button-disabled-mask" title=""></span></span>',
	'image_url' => '/dynamic/pfp/' . htmlspecialchars($__user_h->fetch_pfp($_video['author'])),
	'public_name' => htmlspecialchars($_user2['title']),
	'channel_title' => htmlspecialchars($_user2['title']),
