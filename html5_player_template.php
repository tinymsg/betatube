...
Small Capitals
    ...
    <div class="html5-popup-dialog-body">
      <p>
Get <a href="/watch?v=rick">help setting up HTML5 3D</a>, or change 3D viewing modes.
      </p>
    </div>
    <div class="html5-popup-dialog-buttons">
    ...
    <div class="html5-info-bar-buttons">
      ...
      <div class="html5-info-bar-logo hid">Betatube</div>
    </div>
...
Quality
      ...
      <li class="yt-uix-button-menu-item" data-value="hd720">
        <span class="yt-uix-button-menu-close">720p</span>
      </li>
...
Speed
      ...
      <li class="yt-uix-button-menu-item" data-value="3.0">
        <span class="yt-uix-button-menu-close">3.0x</span>
      </li>
      ...
      <li class="yt-uix-button-menu-item" data-value="0.10">
        <span class="yt-uix-button-menu-close">0.1x</span>
      </li>
    </ul>
  </div>
</div></button>
